...
def main():
    ...
    if TEST:
        ...
        words.add_terms('mn_le_erps.txt', directory=TERMS_DIR)
        words.add_terms('mn_le_exclude.txt', term_type='exclusions', directory=TERMS_DIR)
        words.add_labels('mn_le_erp_labels.txt', directory=TERMS_DIR)
